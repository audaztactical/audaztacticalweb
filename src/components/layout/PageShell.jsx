    ...
    <div className="relative mx-auto max-w-5xl space-y-6">
      <header className="flex flex-col gap-4 border-b border-white/10 pb-5 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
        <div className="min-w-0 space-y-2">
          ...
          <h1 className="font-display mt-1 text-2xl font-bold tracking-[0.12em] text-white sm:text-3xl md:text-4xl">{title}</h1>
          {subtitle ? <p className="max-w-2xl font-mono-technical text-xs leading-relaxed text-slate-500">{subtitle}</p> : null}
        </div>
